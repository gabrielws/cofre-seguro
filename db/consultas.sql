...
insert into usuarios (nome, email, senha, nivel) VALUES ('Gabriel', 'gabriel@email.com', 'teste', 3);
insert into usuarios (nome, email, senha, nivel) VALUES ('João', 'joao@email.com', 'teste', 1);
insert into usuarios (nome, email, senha, nivel) VALUES ('Maria', 'maria@email.com', 'teste', 1);
...
insert into senhas (idUsuario, nome, senha, site, url) values (2, 'GDrive', '123456', 'drive.google.com', 'https://drive.google.com/');
...
insert into senhas (idUsuario, nome, senha, site, url) values (2, 'Hotmail', '123456', 'hotmail.com', 'https://outlook.live.com/owa/');
insert into senhas (idUsuario, nome, senha, site, url) values (2, 'Yahoo', '123456', 'yahoo.com', 'https://login.yahoo.com/');

insert into senhas (idUsuario, nome, senha, site, url) values (3, 'GDrive', '123456', 'drive.google.com', 'https://drive.google.com/');
insert into senhas (idUsuario, nome, senha, site, url) values (3, 'Gmail', '123456', 'gmail.com', 'https://mail.google.com/');
insert into senhas (idUsuario, nome, senha, site, url) values (3, 'Outlook', '123456', 'outlook.com', 'https://outlook.live.com/owa/');
insert into senhas (idUsuario, nome, senha, site, url) values (3, 'Hotmail', '123456', 'hotmail.com', 'https://outlook.live.com/owa/');
insert into senhas (idUsuario, nome, senha, site, url) values (3, 'Yahoo', '123456', 'yahoo.com', 'https://login.yahoo.com/');
